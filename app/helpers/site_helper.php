...
//---------------------------------------------------------------------------
/**
 * Função que determina para todo site se é acesso de dispositivo Móvel ou não.
 * Neste caso, apenas Smartphones são dispositivos móveis.
 */
if(!function_exists('is_mobile')){
    function is_mobile() {
        $ci = &get_instance();
        
        if($ci->mobiledetect->isTablet()){
            return false;
        } else if($ci->mobiledetect->isMobile()){
            return true;
        } else {
            return false;
        }
...
// -------------------------------------------------------------------------
/**
 * Dependendo do dispositivo, o tamanho das thumbnails é diferente.
 */
if(!function_exists('responsive_thumb')){
    function responsive_thumb($str = '') {
        if(is_mobile()){
            return thumb($str);            
        }
        else{
 ...
 * é diferente.
 */
if(!function_exists('responsive_max')){
    function responsive_max($str = '') {
        if(is_mobile()){
            return grande($str);            
        }
        else{
