...
<input name="nick_edita" id="nick_edita" type="text" class="input-apelido" title="Endereço amigável" placeholder="Endereço amigável" value="<?php echo set_value('nick', $row['nick']);?>" readonly="readonly"/>
    ...
    <div class="control-group -box">
		...
		<label for="meta-videos" class="lb-full">Conteúdos tagueados</label>
		<input id="meta-videos" name="meta-videos" type="text" class="taginput" value="<?php echo get_meta($metas, 'meta-videos', null, true) ?>">
			<div class="help-block">YouTube => yt:CODIGO</div>
...
<div class="panel-right clearfix">
	...
	<label for="tags" class="lb-full">Cliente</label>
