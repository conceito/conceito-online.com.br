...
<div class="inner-row">
	...
	<div class="menu">
		<ul class="unstyled">
			...
			<li class="<?php echo (strstr($this->body_class,'home') !== false)?'active':'';?>">
				<a href="<?php echo site_url(); ?>">Início</a></li>

			<li class="<?php echo ($this->uri_seg[1] == 'portfolio')?'active':''; ?>">
				<a href="<?php echo site_url('portfolio'); ?>">Portfólio</a></li>

			<li class="<?php echo ($this->uri_seg[1] == 'servicos')?'active':''; ?>">
				<a href="<?php echo site_url
				('servicos'); ?>">Serviços</a></li>

			<li class="<?php echo ($this->uri_seg[1] == 'contato')?'active':''; ?>">
				<a href="<?php echo site_url('contato'); ?>">Contato</a></li>
